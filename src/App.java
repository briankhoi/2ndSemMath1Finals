...
public class App extends JFrame implements ActionListener {
  ...
  App() {
    ...
    genFinal = new JButton("Finals");
    restart =  new JButton("Click for more practice!");
    ...
    Chapter10Msg = new JLabel("Chapter 10: More Lines and Angles");
      ...
      new ActionListener() {
        public void actionPerformed(ActionEvent e) {
          for (int i = 0; i < Questions.size(); i++) {
            ...
            scoreLabel.setText("Score: " + Questions.get(0).getScore());
        }
      }
    );
