...
public class expTable extends Chapter6 {
  ...
  public String generateLinExpTable() {
    ...
    Object incExpValues[][] = { { -2, getIncExpValue(-2) }, { -1, getIncExpValue(-1) }, { 0, getIncExpValue(0) },
        { 1, getIncExpValue(1) }, { 2, getIncExpValue(2) } };
    Object decExpValues[][] = { { -2, getDecExpValue(-2) }, { -1, getDecExpValue(-1) }, { 0, getDecExpValue(0) },
        { 1, getDecExpValue(1) }, { 2, getDecExpValue(2) } };
    Object expValues[][];
    ...
    Object linValues[][] = { { -2, getLinValue(-2) }, { -1, getLinValue(-2) }, { 0, getLinValue(0) },
        { 1, getLinValue(1) }, { 2, getLinValue(2) } };
    if (linExp == 1){
      makeTable(expValues, variables);
    } else {
      makeTable(linValues, variables);
    }
    setAnswer(linExp);
  ...
  public String makeGeoTable() {
    Object geoValues[][] = { { -2, getGeoValue(-2) }, { -1, getGeoValue(-1) }, { 0, getGeoValue(0) },
        { 1, getGeoValue(1) } };
    String variables[] = { "x", "y" };
